...
?>
<TR><TD width="<?php echo CATEGORY_IMG_SIZE; ?>" class="tvalue"><img width="<?php echo CATEGORY_IMG_SIZE; ?>" height="<?php echo CATEGORY_IMG_SIZE; ?>" src="<?php echo $row[2]; ?>"></TD><TD class="btvalue"><a href="admin.php?action=products&category=<?php echo $row[0]; ?>"><?php echo htmlspecialchars($row[1]); ?></a></TD><TD class="tvalue" align="center"><a href="admin.php?action=categories&edit=<?php echo $row[0]; ?>"><img height="20" src="images/edit.png"></a></TD><TD class="tvalue" align="center"><a href="admin.php?action=categories&delete=<?php echo $row[0]; ?>"><img height="20" src="images/delete.png"></a></TD></TR>
<?php
} 
?>
</table>
