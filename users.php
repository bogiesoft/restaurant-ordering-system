...
$sql = "insert into users(first_name, last_name, username, password, type) values ('" .$_POST['firstname'] ."','" .$_POST['lastname'] ."','" .$_POST['username'] ."','" .md5($_POST['password']) ."','" .$_POST['account_type']."')";
$db->query($sql);
}

//Edit user data
if(isset($_POST['edituser'])){
$sql = "update users set first_name='" .$_POST['firstname'] ."', last_name='" .$_POST['lastname'] ."',type= '" .$_POST['account_type']."', username='" .$_POST['username'] ."' " .($_POST['password']=="" ? "" : ",password='" .md5($_POST['password']) ."' ") ."where id=" .$_POST['user_id'];
$db->query($sql);
}
...
?>
<form action="manager.php?action=users" onsubmit="return validate_edit_form(this);" method="POST">
...
<TR><TD><?php echo LOGIN_ACCOUNT_TYPE?></TD><TD><input type ="text" name = "account_type" value="<?php echo htmlspecialchars($row[5]);?>">
...
?>
<form action="manager.php?action=users" onsubmit="return validate_form(this);" method="POST">
...
<TR><TD><?php echo LOGIN_PASSWORD; ?></TD><TD><input type="text" name="password"></TD></TR>
<TR><TD><?php echo LOGIN_CONFIRM_PASSWORD; ?></TD><TD><input type="text" name="confirm_password"></TD></TR>
<TR><TD><?php echo LOGIN_ACCOUNT_TYPE; ?></TD><TD><input type="text" name="account_type"></TD></TR>
...
<script language="JavaScript">
  function delete_user(user){
    ...
    if(op)document.location.href="manager.php?action=users&delete="+user;
  }
</script>
<table cellspacing="0">
...
?><TR><TD class="tvalue"><?php echo htmlspecialchars($row[3]); ?></TD><TD class="tvalue"><?php echo htmlspecialchars($row[1] ." " .$row[2]); ?></TD><TD class="tvalue" align="center"><a href="manager.php?action=users&edit=<?php echo $row[0]; ?>"><img src="images/edit.png"></a></TD><TD class="tvalue" align="center"><a href="javascript:delete_user(<?php echo $row[0]; ?>)"><img height=20 src="images/delete.png"></a></TD></TR><?php
}
?>
<TR><TD></TD></TR>
</table>
