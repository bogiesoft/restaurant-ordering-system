...
<TR><TH width="15%" colspan="2"><?php echo TXT_ITEM_NAME; ?></TH><TH width="100" align="left"><?php echo TXT_ITEM_NUMBER; ?></TH>
<TH width="8%" align="left"><?php echo TXT_BRAND; ?></TH>
<TH width="8%" align="left"><?php echo TXT_CATEGORY; ?></TH>
...
<TH width="5%"><?php echo TXT_REORDER_LEVEL;?></TH>
...
<TD width="8%" class="tvalue"><?php if(isset($brand[0])) echo htmlspecialchars($brand[0]); else echo "-"; ?></TD>
<TD width="8%" class="tvalue"><?php if(isset($category[0])) echo htmlspecialchars($category[0]); else echo "-"; ?></TD>
...
<TD width="5%" align="center" class="tvalue"><?php echo htmlspecialchars($row[13]); ?></TD>
<TD width="5%" align="center" class="tvalue"><?php echo htmlspecialchars($row[12]); ?></TD>
<TD width="5%" align="center" class="tvalue"><a href="admin.php?action=products&#038;edit_item=<?php echo $row[0]; ?>"><img height="20" src="images/edit.png"></a></TD>
<TD width="5%" align="center" class="tvalue"><a href="Javascript:delete_item(<?php echo $row[0]; ?>)"><img height="20" src="images/delete.png"></a></TD>
</TR>
<?php
}
?>
