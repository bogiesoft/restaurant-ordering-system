...
?>
<TR><TD class="tvalue"><?php echo htmlspecialchars($row[1]); ?></TD><TD class="tvalue"><?php echo htmlspecialchars($row[2]); ?>&nbsp;</TD><TD class="tvalue"><?php echo htmlspecialchars($row[3]); ?>&nbsp;</TD><TD class="tvalue"><?php echo htmlspecialchars($row[4]); ?>&nbsp;</TD><TD class="tvalue" align="center"><a href="admin.php?action=suppliers&#038;edit_supplier=<?php echo $row[0]; ?>"><img height="20" src="images/edit.png"></a></TD><TD class="tvalue" align="center"><a href="javascript:delete_supplier(<?php echo $row[0]; ?>)"><img height="20" src="images/delete.png"></a></TD></TR>
<?php
}
?>
</table>
