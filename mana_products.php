...
<form name="frm_new_item" action="manager.php?action=products" enctype="multipart/form-data" method="POST">
...
<form action="manager.php?action=products" method="POST">
...
<script language="JavaScript">
  function delete_item(item){
    ...
    if(op)document.location.href="manager.php?action=products&delete=" + item;
  }
</script>
<TR>
