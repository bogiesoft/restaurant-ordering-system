...
?>
/*
<form action="manager.php?action=categories" enctype="multipart/form-data" method="post">
...
<br>
<table cellspacing="0">
<TR><TH colspan="2" width="400"><?php echo TXT_CATEGORY; ?></TH></TR>
<?php
$sql = "select * from categories";
$result = $db->query($sql);
while($row = mysql_fetch_row($result)){
?>
<TR><TD width="<?php echo CATEGORY_IMG_SIZE; ?>" class="tvalue"><img width="<?php echo CATEGORY_IMG_SIZE; ?>" height="<?php echo CATEGORY_IMG_SIZE; ?>" src="<?php echo $row[2]; ?>"></TD><TD class="btvalue"><a href="manager.php?action=products&category=<?php echo $row[0]; ?>"><?php echo htmlspecialchars($row[1]); ?></a></TD></TR>
<?php
} 
?>
</table>
