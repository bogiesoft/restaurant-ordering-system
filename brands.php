...
?><TR><TD class="btvalue"><a href="admin.php?action=products&brand=<?php echo $row[0]; ?>"><?php echo htmlspecialchars($row[1]); ?></a></TD><TD class="tvalue" align="center"><a href="admin.php?action=brands&edit=<?php echo $row[0]; ?>"><img height="20" src="images/edit.png"></a></TD><TD class="tvalue" align="center"><a href="admin.php?action=brands&delete=<?php echo $row[0]; ?>"><img height="20" src="images/delete.png"></a></TD></TR><?php
}
?>
<TR><TD></TD></TR>
</table>
