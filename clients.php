...
$sql = "insert into customers(first_name, last_name, account_number, address, city, pcode, state, country, phone_number, email, discount, comments) values('" .$_POST['firstname'] ."','" .$_POST['lastname'] ."','" .$_POST['account_number'] ."','" .$_POST['address'] ."','" .$_POST['city'] ."','" .$_POST['pcode'] ."','" .$_POST['state'] ."','" .$_POST['country'] ."','" .$_POST['phone_number'] ."','" .$_POST['email'] . "','" . $_POST['discount'] . "','" . $_POST['comments'] ."')";
$db->query($sql);
}

//Edit customer data
if(isset($_POST['editcustomer'])){
$sql = "update customers set first_name='" .$_POST['firstname'] ."', last_name='" .$_POST['lastname'] ."', account_number='" .$_POST['account_number'] ."', address='" .$_POST['address'] ."', city='" .$_POST['city'] ."', pcode='" .$_POST['pcode'] ."', state='" .$_POST['state'] ."', country='" .$_POST['country'] ."', phone_number='" .$_POST['phone_number'] ."', email='" .$_POST['email'] ."', discount='" .$_POST['discount'] ."', comments='" .$_POST['comments'] ."' where id=" .$_POST['customer_id'];
$db->query($sql);
}
...
<table>
<TR><TD><?php echo TXT_RESTAURANT_NAME; ?></TD><TD><input type="text" name="firstname" size="40"></TD></TR>
<TR><TD><?php echo TXT_RESTAURANT_NICKNAME; ?></TD><TD><input type="text" name="lastname" size="40"></TD></TR>
...
<TR><TD><?php echo TXT_DISCOUNT; ?></TD><TD><input type="text" size="10" name="discount"></TD></TR>
...
<table>
<TR><TD><?php echo TXT_RESTAURANT_NAME; ?></TD><TD><input type="text" name="firstname" size="40" value="<?php echo htmlspecialchars($row[1]); ?>"></TD></TR>
<TR><TD><?php echo TXT_RESTAURANT_NICKNAME; ?></TD><TD><input type="text" name="lastname" size="40" value="<?php echo htmlspecialchars($row[2]); ?>"></TD></TR>
...
<TR><TD><?php echo TXT_DISCOUNT; ?></TD><TD><input type="text" size="3" name="discount" style="text-align: right;" value="<?php echo htmlspecialchars($row[11]); ?>"> %</TD></TR>
<TR><TD valign="top"><?php echo TXT_COMMENTS; ?></TD><TD><textarea rows="5" cols="50" name="comments"><?php echo htmlspecialchars($row[12]); ?></textarea></TD></TR>
...
<input type="button" value="<?php echo ADD_NEW_RESTAURANT; ?>" onclick="document.location.href='admin.php?action=clients&#038;add_customer'"><br><br>
<table cellspacing="0">
...
?>
<TR><TD class="tvalue"><?php echo $row[0]; ?></TD><TD class="tvalue"><?php echo htmlspecialchars($row[1] ." " .$row[2]); ?></TD><TD class="tvalue"><?php echo htmlspecialchars($row[9]); ?>&nbsp;</TD><TD class="tvalue"><?php echo htmlspecialchars($row[10]); ?>&nbsp;</TD><TD class="tvalue" align="center"><A href="admin.php?action=clients&#038;edit_customer=<?php echo $row[0]; ?>"><img height="20"  src="images/edit.png"></A></TD><TD class="tvalue" align="center"><A href="javascript:delete_customer(<?php echo $row[0]; ?>)"><img height="20" src="images/delete.png"></A></TD></TR>
<?php
}
?>
</table>
